...
ui <- dashboardPage(skin = "purple",
                    ...
                    dashboardSidebar(
                      sidebarMenu(
                        ...
                        menuItem("Où sont les offres ?",tabName = "carte",icon = icon("globe-europe")),
                        menuItem("Mots co-occurrents",tabName = "cooccurent",icon = icon("project-diagram")),
...
server <- function(input, output) {
  ...
  output$map <- renderHighchart({
    ...
    final$Salaire <- round(as.double(final$Salaire))
